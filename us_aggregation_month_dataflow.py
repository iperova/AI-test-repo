...
class ExecuteBigQuerySQL(beam.DoFn):
    ...
    def process(self, element):
        ...
        yield f"US month aggregation tables were created successfully"
...
def run():
    ...
    pipeline_options = PipelineOptions(
        ...
        project=PROJECT_ID,
        job_name = 'us-aggregation-month-pipeline',
        temp_location='gs://kw-ds-vertex-ai-test/temp',
        staging_location='gs://kw-ds-vertex-ai-test/staging',
        template_location='gs://kw-ds-vertex-ai-test/templates/us_aggregation_month_template',
    ...
    with beam.Pipeline(options=pipeline_options) as pipeline:
        ...
        for housing_type in property_types:
            ...
            QUERY_TEMPLATE = f"""
                    CREATE OR REPLACE TABLE `kw-data-science-playgorund.avm_us_{housing_type}_new_source.us_2019_month` AS
                    WITH 
                    ...
                    WHERE 
                      ...
                      AND close_dt >= DATE_SUB(CURRENT_DATE(), INTERVAL 3 MONTH) 
                    ...
                    FROM t_final
                    WHERE t_final.listing_id NOT IN (
...
(
  ...
  FROM `kw-data-science-playgorund.avm_us_{housing_type}_new_source.us_2019_month`
...
CREATE OR REPLACE TABLE `kw-data-science-playgorund.avm_us_{housing_type}_new_source.us_2019_bg_month` AS
WITH
t_raw_bg_data AS 
(
  SELECT 
...
QUALIFY ROW_NUMBER() OVER (PARTITION BY listing_id order by listing_id desc) = 1;
                    ...
                    CREATE OR REPLACE TABLE `kw-data-science-playgorund.avm_us_{housing_type}_new_source.us_2019_bg_prec_month` AS 
                    WITH 
                    t_precisely AS 
                    (
                      SELECT
                    ...
                    (
                      ...
                      FROM 
                        `kw-data-science-playgorund.avm_us_{housing_type}_new_source.us_2019_bg_month` AS list
                    ...
                    CREATE OR REPLACE TABLE `kw-data-science-playgorund.avm_us_{housing_type}_new_source.us_2019_bg_prec_econ_month` AS
                    ...
                    (
                      ...
                      l.state_prov_short
                      FROM `kw-data-science-playgorund.avm_us_{housing_type}_new_source.us_2019_bg_prec_month` AS l
                    ...
                    CREATE OR REPLACE TABLE `kw-data-science-playgorund.avm_us_{housing_type}_new_source.schools_us_2019_month`
                    AS
                    WITH t_school AS
                    (
                    SELECT 
                    ...
                    FROM `kw-data-science-playgorund.avm_us_{housing_type}_new_source.us_2019_bg_prec_econ_month` AS l, t_school
                    ...
                    FROM `kw-data-science-playgorund.avm_us_{housing_type}_new_source.us_2019_bg_prec_econ_month` AS l
                    ...
                    CREATE OR REPLACE TABLE `kw-data-science-playgorund.avm_us_{housing_type}_new_source.us_2019_bg_prec_econ_school_month` AS
                    ...
                    FROM `kw-data-science-playgorund.avm_us_{housing_type}_new_source.us_2019_bg_prec_econ_month`
                        INNER JOIN `kw-data-science-playgorund.avm_us_{housing_type}_new_source.schools_us_2019_month` USING (listing_id);


                    CREATE OR REPLACE TABLE `kw-data-science-playgorund.avm_us_{housing_type}_new_source.{housing_type}_us_2019_prophet_raw_month`  AS
                    ...
                    FROM `kw-data-science-playgorund.avm_us_{housing_type}_new_source.us_2019_bg_prec_econ_school_month`
                    WHERE TRUE
                    ...
                    CREATE OR REPLACE TABLE `kw-data-science-playgorund.avm_us_{housing_type}_new_source.{housing_type}_us_2019_prophet_month`  AS
                    ...
                    FROM `kw-data-science-playgorund.avm_us_{housing_type}_new_source.{housing_type}_us_2019_prophet_raw_month`;


                    INSERT `kw-data-science-playgorund.avm_us_{housing_type}_new_source.us_2019`
                    SELECT *
                    FROM `kw-data-science-playgorund.avm_us_{housing_type}_new_source.us_2019_month`
                    ;

                    INSERT `kw-data-science-playgorund.avm_us_{housing_type}_new_source.us_2019_bg`
                    SELECT *
                    FROM `kw-data-science-playgorund.avm_us_{housing_type}_new_source.us_2019_bg_month`
                    ;

                    INSERT `kw-data-science-playgorund.avm_us_{housing_type}_new_source.us_2019_bg_prec`
                    SELECT *
                    FROM `kw-data-science-playgorund.avm_us_{housing_type}_new_source.us_2019_bg_prec_month`
                    ;

                    INSERT `kw-data-science-playgorund.avm_us_{housing_type}_new_source.us_2019_bg_prec_econ`
                    SELECT *
                    FROM `kw-data-science-playgorund.avm_us_{housing_type}_new_source.us_2019_bg_prec_econ_month`
                    ;

                    INSERT `kw-data-science-playgorund.avm_us_{housing_type}_new_source.us_2019_bg_prec_econ_school`
                    SELECT *
                    FROM `kw-data-science-playgorund.avm_us_{housing_type}_new_source.us_2019_bg_prec_econ_school_month`
                    ;

                    INSERT `kw-data-science-playgorund.avm_us_{housing_type}_new_source.{housing_type}_us_2019_prophet_raw`
                    SELECT *
                    FROM `kw-data-science-playgorund.avm_us_{housing_type}_new_source.{housing_type}_us_2019_prophet_raw_month`
                    ;
...
# python us_aggregation_month_dataflow.py --worker_machine_type=e2-standard-4
...
#         }
#     }' \
#     "https://dataflow.googleapis.com/v1b3/projects/kw-data-science-playgorund/locations/us-east1/templates:launch?gcsPath=gs://kw-ds-vertex-ai-test/templates/us_aggregation_month_template"
